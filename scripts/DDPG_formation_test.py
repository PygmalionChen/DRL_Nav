...
class DDPG(object):
    def __init__(self, a_dim, s_dim, p_dim, ):
        ...
        # self.saver.restore(self.sess, "/home/pygmalionchen/PycharmProjects/treasure/logs/pddpg/models/formation/model_190000.ckpt")
        self.saver.restore(self.sess,"/home/pygmalionchen/PycharmProjects/treasure/logs/pddpg/formation/model_190000.ckpt")
        # self.saver.restore(self.sess,"/home/pygmalionchen/PycharmProjects/treasure/logs/pddpg/Goodmodels/model_53000.ckpt")
        # self.saver.restore(self.sess,"/home/pygmalionchen/PycharmProjects/treasure/logs/pddpg/SingleGood/model_38750.ckpt")
